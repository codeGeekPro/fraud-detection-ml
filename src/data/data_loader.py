...
class DataLoader:
    ...
    def _validate_data(self, data: pd.DataFrame) -> pd.DataFrame:
        ...
        # Vérification des valeurs de classe valides
        if not set(data['Class'].unique()).issubset({0, 1}):
            raise ValueError("La colonne 'Class' doit contenir uniquement 0 et 1")
    ...
    def _save_splits(self, train_data: pd.DataFrame, val_data: pd.DataFrame, 
